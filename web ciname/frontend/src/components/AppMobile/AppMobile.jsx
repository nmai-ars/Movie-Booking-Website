                  ...
                  <div className="mobile__frame">
                    ...
                    >
                      ...
                      <div className="item">
                        <img
                          className="img-fluid"
                          src="https://movie-booking-project.vercel.app/img/mobile/slide10.jpg"
                          alt="hinhanh"
                        />
                      </div>
                      <div className="item">
                        <img
                          className="img-fluid"
                          src="https://movie-booking-project.vercel.app/img/mobile/slide12.jpg"
                          alt="hinhanh"
                        />
                      </div>
                      <div className="item">
                      ...
                      <div className="item">
                        <img
                          className="img-fluid"
                          src="https://movie-booking-project.vercel.app/img/mobile/slide6.jpg"
                          alt="hinhanh"
                        />
                      </div>
                      <div className="item">
